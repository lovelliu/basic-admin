<script lang="ts" setup>
  ...
  import { activityFormSchema, BasicFormSchema, detailFormSchema, SalesFormSchema } from './data';
  import { useGo } from '/@/hooks/web/usePage';
  import { formatToDateTime } from '/@/utils/dateUtil';
  import { getCourseById, saveOrUpdateCourse } from '/@/api/business/course';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { computed } from 'vue';
  import { CourseInfo } from '/@/api/business/model/course';
  ...
  async function submitAll() {
    ...
    if (activityValues.activityCourse) {
      let { amount, beginTime, endTime, stock } = activityValues;
...
<template>
  <PageWrapper :title="title" @back="go('/course/index')" class="pb-10">
    <Card title="基本信息">
