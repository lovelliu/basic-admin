...
export default defineComponent({
  ...
  setup(props, { attrs, emit, slots, expose }) {
    ...
    function handleTableChange(...args) {
      onTableChange.call(undefined, ...args) // eslint-disable-line no-useless-call
      emit('change', ...args)
      // 解决通过useTable注册onChange时不起作用的问题
      const { onChange } = unref(getProps)
      onChange && isFunction(onChange) && onChange.call(undefined, ...args) // eslint-disable-line no-useless-call
    }
